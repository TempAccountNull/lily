...
auto GetDrawPairArray() {
	return make_array(
		...
		std::pair<Bones, Bones>{ neck_01, upperarm_l },
		std::pair<Bones, Bones>{ upperarm_l, lowerarm_l },
		std::pair<Bones, Bones>{ lowerarm_l, hand_l },
		std::pair<Bones, Bones>{ neck_01, spine_02 },
		std::pair<Bones, Bones>{ spine_02, spine_01 },
		std::pair<Bones, Bones>{ spine_01, pelvis },
		std::pair<Bones, Bones>{ pelvis, thigh_r },
		std::pair<Bones, Bones>{ thigh_r, calf_r },
		std::pair<Bones, Bones>{ calf_r, foot_r },
		std::pair<Bones, Bones>{ pelvis, thigh_l },
		std::pair<Bones, Bones>{ thigh_l, calf_l },
		std::pair<Bones, Bones>{ calf_l, foot_l }
	);
}