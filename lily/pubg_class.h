...
DefClass(UWorld, UObject,
	...
	MemberAtOffset(EncryptedPtr<UGameInstance>, GameInstance, 0x7C8)

	MemberAtOffset(float, TimeSeconds, 0x320)
	,
	constexpr static uintptr_t UWORLDBASE = 0x8D17660;
...
DefClass(ULevel, UObject,
	MemberAtOffset(EncryptedPtr<TArray<NativePtr<AActor>>>, Actors, 0x180)
)
...
DefClass(AActor, UObject,
	...
	MemberAtOffset(TSet<NativePtr<UActorComponent>>, OwnedComponents, 0x110)
	,
