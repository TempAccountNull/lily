...
static ItemInfo GetItemInfo(unsigned Hash) {
	switch (Hash) {
		...
		HASH_CASE("Item_Attach_Weapon_Lower_Foregrip_Croosbow_C"h, { "L_Fore_Cross"e, 1 });
		...
		HASH_CASE("Item_Attach_Weapon_Magazine_ExtendedQuickDraw_Small_C"h, { "EQ_P"e, 1 });
		...
		HASH_CASE("Item_Attach_Weapon_Magazine_QuickDraw_SniperRifle_C"h, { "Q_SR"e, 1 });
		...
		HASH_CASE("Item_Attach_Weapon_Muzzle_Suppressor_Medium_C"h, { "S_SMG"e, 2 });
		HASH_CASE("Item_Attach_Weapon_Muzzle_Suppressor_Small_C"h, { "S_P"e, 1 });
		HASH_CASE("Item_Attach_Weapon_Muzzle_Suppressor_SniperRifle_C"h, { "S_SR"e, 4 });
		HASH_CASE("Item_Attach_Weapon_SideRail_DotSight_RMR_C"h, { "S_Dot"e, 2 });
		...
		HASH_CASE("Item_Weapon_Mini14_C"h, { "Mini"e, 4 });
		HASH_CASE("Item_Weapon_Mk14_C"h, { "Mk14"e, 4 });
		HASH_CASE("Item_Weapon_Molotov_C"h, { "Molotov"e, 2 });
		...
		HASH_CASE("Item_Weapon_SKS_C"h, { "SKS"e, 4 });
		HASH_CASE("Item_Weapon_SmokeBomb_C"h, { "Smoke"e, 2 });
		HASH_CASE("Item_Weapon_Thompson_C"h, { "Tom"e, 2 });
		HASH_CASE("Item_Weapon_UMP_C"h, { "UMP"e, 2 });
		HASH_CASE("Item_Weapon_UZI_C"h, { "UZI"e, 2 });
		HASH_CASE("Item_Weapon_Vector_C"h, { "Vec"e, 2 });
		HASH_CASE("Item_Weapon_VSS_C"h, { "VSS"e, 2 });
		...
		HASH_CASE("Item_Weapon_DesertEagle_C"h, { "Deagle"e, 2 });
		...
		HASH_CASE("Item_Weapon_Mk47Mutant_C"h, { "Mutant"e, 3 });
		HASH_CASE("Item_Weapon_MP5K_C"h, { "MP5K"e, 2 });
		HASH_CASE("Item_Weapon_Mads_QBU88_C"h, { "QBU"e, 4 });
		HASH_CASE("Item_Weapon_QBU88_C"h, { "QBU"e, 4 });
		...
		HASH_CASE("Item_Weapon_vz61Skorpion_C"h, { "Skorpion"e, 1 });
		...
		HASH_CASE("Item_Weapon_BluezoneGrenade_C"h, { "BlueBomb"e, 4 });
